% generatePlanck Calculate emission using Planck's law
%
...
if nargout==0
    ...
    label=sprintf('Planck curve for T=%g',temperature);
    title(label);
else
