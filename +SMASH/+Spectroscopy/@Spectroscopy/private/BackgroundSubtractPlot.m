...
function [Type,InterpolatedBackground,ReturnPoints]=BackgroundSubtractPlot(obj,x,y)
    ...
    function BackgroundFit(BackgroundDropdown,~)
        ...
        if strcmp('Flat',result)==1
            ...
            hold on
            InterpolatedBackground=obj.BackgroundSubtract(x,y,'Flat',pointy);
            ReturnPoints=pointy;
        elseif strcmp('PolyFit',result)==1
            ...
            InterpolatedBackground=obj.BackgroundSubtract(x,y,'Polynomial',[xpoints,ypoints],'Order',order);            
        ...
        elseif strcmp('MedianFit',result)==1
            ...
            hold on
            InterpolatedBackground=obj.BackgroundSubtract(x,y,'MedianFilter',order);
            ReturnPoints=order;
        end
