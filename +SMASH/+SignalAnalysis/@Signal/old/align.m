...
% handle input
if nargin<2
    error('ERROR: at least two signals needed for time base alignment');
end
...
for n=1:nargin
    if isprop(varargin{n},'Grid') && isprop(varargin{n},'Data')
        ...
        error('ERROR: cannot align input #%d',n);
    end
end
if left==right
