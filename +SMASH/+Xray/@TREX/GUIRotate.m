...
setappdata(figRadiography, 'obj_Rotate', []);
...
object.Measurement = getappdata(figRadiography, 'obj_Rotate');
delete(figRadiography);
    ...
    function CWcallback(varargin)
        ...
        hold off
        cla(ax1)
        imagesc(object.Measurement.Grid1,object.Measurement.Grid2,object.Measurement.Data,'Parent',ax1);
        hold on
        GridPlot()
    end

    function CCWcallback(varargin)
        object.Measurement = rotate(object.Measurement,'left');
        axes(ax1)
        hold off
        cla(ax1)
        imagesc(object.Measurement.Grid1,object.Measurement.Grid2,object.Measurement.Data,'Parent',ax1);
    ...
    function RotCallback(varargin)
        ...
        object_new = rotate(object.Measurement,angle);
        axes(ax1)
        hold off
        cla(ax1)
    ...
    function DoneCallback(varargin)
        ...
        setappdata(figRadiography, 'obj_Rotate', obj_Rot);
    end
