...
switch type
    case 'jkmoore'
        switch format
            case '.pff'
                fileName = strcat('z',num2str(shot),'_jkmoore.pff');                
            case '.hdf'
                fileName = strcat('z',num2str(shot),'_jkmoore.hdf');
        end
    case 'tcwagon'
        switch format
            case '.pff'
                fileName = strcat('z',num2str(shot),'tcwagon.pff');
            case '.hdf'
                fileName = strcat('z',num2str(shot),'tcwagon.hdf');
        end        
end
