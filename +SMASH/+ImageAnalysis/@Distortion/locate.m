...
if Narg>0
    ...
    elseif (Narg==1) && isnumeric(varargin{1}) && size(varargin{1},2)==2
        object.IsoPoints1=varargin{1}(:,1);
        object.IsoPoints2=varargin{1}(:,2);        
...
set(h.image(2),'UIContextMenu',hc);
    ...
    function result=NewGroup(varargin)
        hline=[];
        hline(1)=line('Parent',h.axes(1),'Color',object.LineColor,...
            'XData',[],'YData',[],...
            'LineStyle',object.LineStyle,'Marker',object.Marker,...
            'Tag','IsoPoints');
        hline(2)=line('Parent',h.axes(2),'Color',object.LineColor,...
            'XData',[],'YData',[],...
            'LineStyle',object.LineStyle,'Marker',object.Marker,...
            'Tag','IsoPoints');
