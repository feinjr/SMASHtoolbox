...
h.axes(1)=axes('Parent',h.panel,'Units','normalized','Position',[x0 y0+Ly2 Lx1 Ly1],...
    ...
    'YDir','reverse');
%himage=imagesc('Parent',h.axes(1),'XData',object.Grid1,'YData',object.Grid2,...
%    'CData',object.Data);
temp=show(object,h.axes(1));
himage=temp.image;
colormap(h.figure,object.ColorMap);
caxis(h.axes(1),object.DataLim);
axis(h.axes(1),'tight');
hcrosshair=line('Parent',h.axes(1),'Color',object.LineColor,...
