% edit Edit basis function
%
% This method edits existing basis functions in a Curve object.  Functions
% are referenced by the order in which they were added.
%     >> object=edit(object,index,name1,value1,...);
% Name/value pairs indicate the requested changes.  Valid names are
% 'basis', 'parameter', 'upper', 'lower', 'scale', and 'fixscale'; for more
